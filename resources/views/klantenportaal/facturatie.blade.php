...
@section('content')
    <div class="flex items-center gap-[0.5rem]">
        ...
        <p class="text-[14px] text-[#191919] font-medium">Facturatie</p>
    </div>
    <div id="facturatie">
        <h1 class="text-2xl text-[#191919] font-bold leading-[1] mb-4">Facturatie</h1>
        <p class="text-[#191919] opacity-80 text-sm">Hier is nog niks te vinden...</p>
    </div>
@endsection